...
ESX.RegisterServerCallback('danny_npcrob:amount', function(source,cb)
...
RegisterNetEvent('danny_npcrob:server:robNpc', function(entityId)
...
RegisterNetEvent('danny_npcrob:server:policeAlert', function (pos)
	TriggerClientEvent('danny_npcrob:client:policeAlert', -1, pos)
end)
